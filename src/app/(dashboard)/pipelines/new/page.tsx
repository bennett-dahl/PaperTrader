      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-slate-900 border border-slate-700/50 rounded-xl p-6">
          ...
          <div className="flex gap-2 mb-3">
            <input
              ...
              placeholder="AAPL"
              className="flex-1 bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
            <button
              type="button"
              onClick={addTicker}
          ...
          <div className="flex flex-wrap gap-2">
            {tickerUniverse.map((t) => (
              <span key={t} className="flex items-center gap-1 px-2 py-1 bg-slate-700 text-slate-200 text-sm rounded-lg">
                {t}
                  ...
                  {p.id in selectedPortfolios && (
                    <div className="flex items-center gap-1">
                      <input
                        ...
                        className="w-16 bg-slate-800 border border-slate-700 rounded px-2 py-1 text-slate-100 text-sm focus:outline-none"
                      />
        ...
        <div className="flex gap-3">
          ...
          <button
            type="button"
            onClick={() => router.back()}
            className="px-6 py-2.5 bg-slate-700 hover:bg-slate-600 text-slate-100 rounded-lg transition-colors"
          >
            Cancel
          </button>
        </div>
